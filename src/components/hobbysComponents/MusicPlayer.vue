<template>
  <div class="music-widget">
    <div class="thumbnail">
      ...
      <div class="song-info">
        <h1 class="song-title" ref="song">hello i'm the title</h1>
        <p class="artist-name" ref="artist">Hello i'm the artist</p>
        <audio ref="audio" src="" preload loop id="audio"></audio>
      </div>
    </div>
  ...
  methods: {
    ...
    pushNext: function () {
      ...
      this.$refs.thumbnail.src =
        this.songArray[this.index_selected].album_cover;
      this.$refs.artist.textContent =
        this.songArray[this.index_selected].artist;
